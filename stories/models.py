...
class Scenario(Document):
    ...
    meta = {"collection": "scenarios", "indexes": ["author_id", "title", "created_at"]}
...
class Scene(Document):
    ...
    meta = {"collection": "scenes", "indexes": ["scenario_id", "title", "order"]}
    ...
    sound_id = ReferenceField("Asset")  # Asset son TTS (narration) optionnel
    music_id = ReferenceField("Asset")  # Asset musique d'ambiance optionnel
...
class Choice(Document):
    ...
    meta = {
        "collection": "choices",
        "indexes": ["from_scene_id", "to_scene_id", "text"],
    }
